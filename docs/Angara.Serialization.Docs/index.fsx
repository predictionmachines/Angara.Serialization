...
(** You can find more concepts and information how to serialize user defined types
in the [next tutorial](CustomSerializer.html). 
...
[License file][license] in the GitHub repository. 
  ...
  [gh]: https://github.com/Microsoft/Angara.Serialization
  [issues]: https://github.com/Microsoft/Angara.Serialization/issues
  [license]: https://github.com/Microsoft/Angara.Serialization/blob/master/LICENSE.txt
*)
